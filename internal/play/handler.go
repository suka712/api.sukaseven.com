...
func Play(w http.ResponseWriter, r *http.Request) {
	...
	log.Println("THIS ROUTE IS A DUMMY FOR NOW - IT IS RATELIMITED BY SPOTIFY")
	dummy := PlayResponse{
		IsPlaying:  false,
		Timestamp:  0,
		ProgressMs: 97000,
	...
	util.WriteJSON(w, http.StatusOK, dummy) // THIS SHIT IS TEMPORARY REMOVVVVVVVVVVVVVVVVVVVEEEEEEEEEEEEEEEEEEEEEEEEEEE
	// THIS SHIT IS TEMPORARY REMOVVVVVVVVVVVVVVVVVVVEEEEEEEEEEEEEEEEEEEEEEEEEEE
	return 
